...
Thank you for your interest in raising an issue with Payment Core. An issue can be either a bug report or a feature request.

By reporting bugs, you contribute directly to improving Payment Core. Bug reports help developers identify and fix issues quickly before they affect more users.

Feature requests are also valuable. They help shape the future of the app by introducing new ideas and improvements based on real-world use cases.
...
2. **Version number:**
   Include the Frappe, ERPNext, and payment_core versions you are using. The issue may already be fixed in a newer release.

3. **Clear title:**
   Use a descriptive title (e.g., "Payment Request fails to resolve gateway without the payments app" instead of "Gateway not working").
